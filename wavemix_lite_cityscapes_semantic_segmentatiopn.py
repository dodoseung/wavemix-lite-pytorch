...
train_data = datasets.Cityscapes('~/.pytorch/Cityscapes_data/', split='train', mode='fine', target_type='semantic', transform=transform)
train_loader = torch.utils.data.DataLoader(train_data, batch_size=batch_size, shuffle=shuffle, drop_last=drop_last)

# Set the test data
test_data = datasets.Cityscapes('~/.pytorch/Cityscapes_data/', split='val', mode='fine', target_type='semantic', transform=transform)
...
def valid(test_loader):
  ...
  # Test accuracy
  test_accuracy = 100 * test_accuracy / test_num
